function [] = One2oneNonsmoothPairwiseMaxTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Nonsmooth Pairwise Max Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['_PwMaxPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
