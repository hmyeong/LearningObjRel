function [] = One2oneDataSmoothPairwiseNonsmoothHighorderMaxTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Data Smooth Pairwise Nonsmooth High-order Max Test)');
...
for i = range
    ...
    testSuffix = 'Sampling';
    testName = ['DPwPottsHwMaxPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
    ...
    for j = 1:LORparam.numMultiStart
        [Lsp,EnergyVal] = mexLOROptSmoothPairwiseUndirectedHighOrderMax(unfoldPropagatedLabels,int32(adjPairs),dataCost{1},...
            [-log(minUnfoldPropagatedLabels^3) -log(minUnfoldPropagatedLabels^2) 0 ...
