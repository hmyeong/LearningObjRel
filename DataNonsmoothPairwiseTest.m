function [] = DataNonsmoothPairwiseTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Data Nonsmooth Pairwise Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['DPwSOR' '_retSetSize_' num2str(LORparam.retSetSize)...
