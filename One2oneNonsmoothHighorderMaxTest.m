function [] = One2oneNonsmoothHighorderMaxTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Nonsmooth High-order Max Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['__HwMaxPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
    ...
    for j = 1:LORparam.numMultiStart
        [Lsp,EnergyVal] = mexLOROptUndirectedHighOrderMax(unfoldPropagatedLabels,[],...
