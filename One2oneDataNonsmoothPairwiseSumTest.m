function [] = One2oneDataNonsmoothPairwiseSumTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Data Nonsmooth Pairwise Sum Test)');
...
for i = range
    ...
    secondOrderObjRel = GenSecondOrderObjRelSum(propagatedLabels,reducedLabels,SPdata.Labels{1,1}...
    ...
    testSuffix = '';
    testName = ['DPwSumPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
