function [] = One2oneNonsmoothPairwiseSumTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Nonsmooth Pairwise Sum Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['_PwSumPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
