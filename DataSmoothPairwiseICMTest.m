function [] = DataSmoothPairwiseICMTest(SPdata,SPparam,LORparam)
...
for i = range
    ...
    testSuffix = '';
    testName = ['DPwPottsICM' '_beta_' num2str(LORparam.beta)...
        '_nIter_' num2str(LORparam.numQPBOIter) '_' testSuffix];
    
    for j = 1:LORparam.numMultiStart
        [Lsp,EnergyVal] = mexPottsOptICM(int32(adjPairs),dataCost{1},...
