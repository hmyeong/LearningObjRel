function [] = One2oneDataNonsmoothHighorderMaxTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Data Nonsmooth High-order Max Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['D_HwMaxPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
    ...
    for j = 1:LORparam.numMultiStart
        [Lsp,EnergyVal] = mexLOROptUndirectedHighOrderMax(unfoldPropagatedLabels,dataCost{1},...
            [-log(minUnfoldPropagatedLabels^3) 0 0
