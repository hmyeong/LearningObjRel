function [secondOrderObjRel] = GenSecondOrderObjRelSum(propagatedLabel,reducedLabels,Labels,retSetSize,testSize)
...
for i = 1:length(Labels)
    for j = 1:length(Labels)
        ...
        secondOrderObjRel{i,j} = sum(stackPairwiseRankOneObjRel,2);
