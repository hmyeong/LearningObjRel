...
% im_parser/ImageParser/FindRetrievalSet.m
% http://www.cs.unc.edu/~jtighe/Papers/ECCV10/index.html
%
function [retInds rank ranksort] = FindRetrievalSet(trainGlobalDesc,testGlobalDesc,DataDir,fileName,globalDescriptors,suffix)
