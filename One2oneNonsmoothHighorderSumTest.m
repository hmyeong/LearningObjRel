function [] = One2oneNonsmoothHighorderSumTest(SPdata,SPparam,LORparam)

pfig = ProgressBar('Parsing Images (Nonsmooth High-order Sum Test)');
...
for i = range
    ...
    testSuffix = '';
    testName = ['__HwSumPropagatedLabels' '_retSetSize_' num2str(LORparam.retSetSize)...
    ...
    for j = 1:LORparam.numMultiStart
        [Lsp,EnergyVal] = mexLOROptUndirectedHighOrderSum(unfoldPropagatedLabels,[],...
